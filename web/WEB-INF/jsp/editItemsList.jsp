...
<title>批量修改商品查询</title>
	<script type="text/javascript">
	 function updateItems(){ 
		    if(window.confirm("确定更新所有记录？")){ 
		       var form = document.forms.itemsForm;
		       var url ="${pageContext.request.contextPath}/items/editItemsListSubmit.action";
		       form.action=url;
...
<a href="${pageContext.request.contextPath}/items/queryItems">返回首页</a>
</form>
</body>
